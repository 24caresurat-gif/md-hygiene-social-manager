...
export default function AdminPage(){
 ...
 return <main className="app-shell"><section className="main-shell" style={{width:'100%'}}><header className="main-header"><strong>Admin Control Center</strong><button onClick={()=>void load()}>↻ Refresh</button></header><div className="dashboard-content"><h1>Staff & Workplace Access Management</h1><p className="muted">Assign staff to a workplace and control exactly which platforms and actions they can use.</p>{error?<div className="data-warning">{error}</div>:null}{notice?<div className="data-success">{notice}</div>:null}
