import { NextResponse } from '@supabase/auth-helpers-nextjs';
...
export async function POST(request: Request) {
  ...
  } catch (error) { const errorMessage = error instanceof Error ? error.message : 'Unable to publish to Facebook.'; return NextResponse.json({ error: errorMessage }, { status: 400 }); }
}
