      ...
      <div className="login-shell">
        ...
        <section className="login-card">
          <div className="mobile-brand">
            <div className="login-logo">MD</div>
            <b>MD HYGIENE<small>SOCIAL MEDIA MANAGER</small></b>
          </div>
          ...
          <form onSubmit={submit}>
            ...
            <label>Password
              <div className="field">
                <span>●</span>
                <input type={show ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} autoComplete={isLogin ? 'current-password' : 'new-password'} required minLength={6} placeholder="Enter your password" />
